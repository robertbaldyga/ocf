...
from tests.utils.random import RandomStringGenerator, RandomGenerator, Range
...
@pytest.fixture(params=RandomGenerator(Range.UINT16))
def c_uint16_randomize(request):
    return request.param


@pytest.fixture(params=RandomGenerator(Range.UINT32))
def c_uint32_randomize(request):
    return request.param


@pytest.fixture(params=RandomGenerator(Range.UINT64))
def c_uint64_randomize(request):
    return request.param


@pytest.fixture(params=RandomGenerator(Range.INT))
...
@pytest.fixture(
    params=RandomGenerator(Range.UINT32).exclude_range(enum_range(CacheMode))
)
...
@pytest.fixture(
    params=RandomGenerator(Range.UINT32).exclude_range(enum_range(CacheLineSize))
)
...
@pytest.fixture(
    params=RandomGenerator(Range.UINT32).exclude_range(enum_range(EvictionPolicy))
)
...
@pytest.fixture(
    params=RandomGenerator(Range.UINT32).exclude_range(enum_range(PromotionPolicy))
)
...
@pytest.fixture(
    params=RandomGenerator(Range.UINT32).exclude_range(enum_range(MetadataLayout))
)
